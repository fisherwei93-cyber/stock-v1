...
# [FIX] V105 熔断版: 分段拉取数据，防止热门股(NVDA)因单个模块报错导致全崩
...
def fetch_financial_data_v105(ticker):
    ...
    return {
        "history": h, "info": safe_info, "compare": cmp_norm, "error": None, 
        "upgrades": upgrades, "inst": inst, "insider": insider, "fin": fin, "options": None
    }
